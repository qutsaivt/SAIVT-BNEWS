...
1) Download SAIVT-BNEWS.zip from 
   https://wiki.qut.edu.au/display/saivt/SAIVT-BNEWS

2) Unzip SAIVT-BNEWS.zip and you should have the following folder 
   structure:
   ...
   At this point, you have the SAIVT-BNEWS ground truth information
   and associated meta data. Do download the associated videos,
   continue to follow these instructions:

3) The videos can be downloaded using the information in the
   <videoid>*.txt files on the lines starting with 'media_content:',
   and a python script is provided in the code folder to automate this
